...
const Dropdown = ({ children, anchor }: { children: React.ReactNode, anchor?: React.ReactNode }) => {
    ...
    return (
        <div
            className="shadow-lg bg-slate-50 rounded-lg p-2 relative"
        ...
        >
            ...
            <div
                className={`absolute bg-slate-50 shadow-xl rounded-lg top-12 left-0 transition-all duration-500 ease-in-out ${isOpen
